      ...
      >
        ...
        <div className="glass-panel rounded-[2rem] p-8 md:p-12 border border-white/5 shadow-2xl relative overflow-hidden">
          ...
          <header className="mb-8 relative z-10">
            <h2 className="font-headline font-bold text-3xl text-white tracking-tight leading-tight">Welcome back</h2>
            <p className="text-on-surface-variant font-body text-sm mt-2">Enter your credentials to access your sanctuary.</p>
          </header>
          ...
          <form onSubmit={handleSubmit} className="space-y-6 relative z-10">
            ...
            <div className="space-y-2 group">
              <div className="flex justify-between items-center px-1">
                ...
                <a className="text-[10px] uppercase tracking-widest text-primary hover:text-secondary font-bold transition-colors" href="#">Forgot?</a>
              </div>
              <div className="relative flex items-center coral-glow-focus transition-all duration-300 rounded-full border border-outline-variant bg-surface-container-highest">
        ...
        <div className="mt-10 text-center relative z-10">
          <p className="font-body text-on-surface-variant flex items-center justify-center gap-1">
            New to the pad? 
            <Link to="/register" className="text-white font-bold hover:text-primary transition-colors inline-flex items-center gap-1 group ml-1">
              Create an account
